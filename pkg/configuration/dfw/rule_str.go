...
func (f *FwRule) String() string {
	return fmt.Sprintf("ruleID: %d, src: %s, dst: %s, conn: %s, action: %s, direction: %s, scope: %s, sec-policy: %s",
		f.RuleID, vmsString(f.Src.VMs), vmsString(f.Dst.VMs), f.Conn.String(), string(f.Action), f.direction, vmsString(f.Scope.VMs), f.secPolicyName)
}

func (f *FwRule) effectiveRuleStr() string {
	return fmt.Sprintf("ruleID: %d, src: %s, dst: %s, conn: %s, action: %s, direction: %s, sec-policy: %s",
		f.RuleID, vmsString(f.Src.VMs), vmsString(f.Dst.VMs), f.Conn.String(), string(f.Action), f.direction, f.secPolicyName)
}
