...
/*
func policyDetailedName(p *networking.NetworkPolicy) string {
	return strings.Join([]string{p.Kind, p.Namespace, p.Name}, "/")
}

func adminPolicyDetailedName(p *admin.AdminNetworkPolicy) string {
	return strings.Join([]string{p.Kind, p.Name}, "/")
}
*/
